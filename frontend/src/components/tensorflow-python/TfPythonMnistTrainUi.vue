                  ...
                  <b-tab title="Training" active>
                    ...
                    <div class="col-lg-12" id="appp">
                      <div v-if="!vinnslItem.definition">
                        <br>
                        <b-alert show variant="danger">You must add ViNNSL Definition to your network</b-alert>
                      </div>
                      <!--
                        <b-row>
                          <b-col>
  ...
  export default {
    ...
    methods: {
      ...
      startTrainingById (id) {
        ...
        AXIOS.post(this.$vinnslBackendUrlTensorFlowPython + `/worker/mnist`, {
          id: id,
          epochs: this.epochs,
