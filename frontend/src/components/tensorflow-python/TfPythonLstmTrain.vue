  ...
  export default {
    ...
    methods: {
      ...
      startTrainingById (id) {
        ...
        AXIOS.post(this.$vinnslBackendUrlTensorFlowPython + `/worker/lstm`, {
          id: id,
          text: this.textarea,
          epochs: this.epochs,
      ...
      generateTextById (id) {
        this.generatedtext = ''
        AXIOS.post(this.$vinnslBackendUrlTensorFlowPython + `/worker/lstm/generate/text`, {
          id: id,
      ...
      saveTextInDB (id) {
        AXIOS.post(this.$vinnslBackendUrlTensorFlowPython + `/worker/save/text/lstm`, {
          id: id,
          text: this.textarea
        })
          .then(response => {
